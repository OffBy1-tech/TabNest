...
describe('GroupCard', () => {
  ...
  // content-visibility implies contain:paint, which clips absolutely-positioned
  // popups to the card box — containment must lift while any popup is open.
  it('drops content-visibility containment while the kebab menu is open', () => {
    renderCard();
    const card = screen.getByRole('article', { name: 'Research, 2 tabs' });
