...
import { domainOf } from './ActiveTabsPanel';
              ...
              <React.Fragment key={tabId}>
                ...
                <div
                  ...
                  style={{
                    ...
                    // contain:paint would clip the SavePopover to the row, so
                    // containment lifts while this row's popover is open.
                    contentVisibility: savePopoverTabId === tabId ? undefined : 'auto',
