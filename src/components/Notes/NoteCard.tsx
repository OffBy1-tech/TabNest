  ...
  return (
    <article
      ...
      style={{
        ...
        padding: 'var(--space-4)',
        gap: 'var(--space-2)',
        // contain:paint from content-visibility would trap and clip the
        // fixed-position confirm dialog — lift containment while it is open.
        contentVisibility: confirmDelete ? undefined : 'auto',
